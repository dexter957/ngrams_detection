...
#define SIZE 32
#define LENGTHS 5 //(4.79 (average in text) + 7.60 (average in dictionary)) / SIZE
#define TRUE 1
#define FALSE 0
#define OPPOSITE_MASK -1
...
void static_clearNode(pointerToStaticTrieNode);
...
void shrink(pointerToStaticTrieNode, void**, int*);
